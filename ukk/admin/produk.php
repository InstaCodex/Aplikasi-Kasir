                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <h1 class="h3 mb-3">
                                Data Produk
                                <button class="btn btn-primary float-right" type="button" data-toggle="modal" data-target="#TambahProduk">Tambah Produk</button>
                            </h1>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $kode_produk; ?></td>
                                                <td><?= $nama_produk; ?></td>
                                                <td>Rp<?=number_format($harga_modal);?></td>
                                            ...
                                            <!-- Modal edit -->
                                            <div class="modal fade" id="editProduk<?= $kode_produk; ?>">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" pattern="[A-Za-z\s]+" title="Hanya huruf yang diperbolehkan" id="edit_nama_produk" name="nama_produk" value="<?= $nama_produk; ?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="edit_harga_modal">Harga Modal</label>
                                                                    <input type="number" class="form-control" id="edit_harga_modal" name="harga_modal" value="<?= $harga_modal; ?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="edit_harga_jual">Harga Jual</label>
                                                                    <input type="number" class="form-control" id="edit_harga_jual" name="harga_jual" value="<?= $harga_jual; ?>">
                                                                </div>
                                                            </div>
                                            ...
                                            <!-- Modal hapus -->
                                            <div class="modal fade" id="hapusProduk<?= $kode_produk; ?>">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nama_produk" class="form-control" pattern="[A-Za-z\s]+" title="Hanya huruf yang diperbolehkan" required>
                                                    </div>
                                                    <div class="form-group">
